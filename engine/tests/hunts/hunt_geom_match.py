...
MUTANTS = [
    ...
    m("p2-band-multiplier-drifted",
      ...
      "BAND_BAG_MULTIPLIER = 160",
      "test_locate_band_multiplier_is_the_ruled_p2_value"),
    m("p2-band-regressed-to-superseded-3",
      "BAND_BAG_MULTIPLIER = 16",
      "BAND_BAG_MULTIPLIER = 3",
      "test_locate_default_band_survives_end_matter_token_deserts"),
    m("p2-band-one-under-ruled",
      "BAND_BAG_MULTIPLIER = 16",
      "BAND_BAG_MULTIPLIER = 15",
